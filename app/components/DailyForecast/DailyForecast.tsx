...
function DailyForecast() {
  ...
  //filter the list for todat's forecast
  ...
  if (todaysForecast.length < 1) {
    return <Skeleton className=" h-[12rem] w-full col-span-full
    sm-2:col-span-2 md:col-span-2 xl:col-span-2" />;
  }
  ...
  return (
    <div
      className="pt-6 px-4 h-[12rem] border reounded-lg 
    flex flex-col gap-8 dark:bg-dark-grey shadow-sm dark:shadow-none col-span-full
    sm-2:col-span-2 md:col-span-2 xl:col-span-2"
    >
