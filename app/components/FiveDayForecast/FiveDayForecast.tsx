...
import { clander } from "@/app/utils/Icons";
...
function FiveDayForecast() {
  ...
  return (
    <div className=" pt6 pb-5 px-4 flex-1 border rounded-lg flex flex-col justify-between dark:bg-dark-grey shadow-sm dark:shadow-none">
      <div className="top">
        <h2 className=" flex items-center gap-2 font-medium">
          {clander} 5-Day Forecast for {city.name}
        </h2>
